...
Приложение для просмотра информации о героях вселенной Marvel с понятным  и простым интерфейсом, создано как учебный проект с целью ознакомиться со стеком современных технологий.
